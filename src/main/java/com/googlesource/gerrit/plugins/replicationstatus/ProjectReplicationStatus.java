...
public abstract class ProjectReplicationStatus {
  static ProjectReplicationStatus create(
      Map<String, RefReplicationStatus> ref,
      ProjectReplicationStatusResult status,
      String project) {
    return new AutoValue_ProjectReplicationStatus(ref, status, project);
  }

  public abstract Map<String, RefReplicationStatus> ref();
